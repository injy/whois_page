// Auto-generated WHOIS server data
// Sources: IANA + custom overrides

// Simple hostname map (most entries)
...
// Custom query formats for servers that need non-standard queries
// The query template uses %s as placeholder for the domain name
export const WHOIS_CUSTOM_QUERIES: Record<string, { host: string; query: string }> = {
