...
(function(){
  ...
  // Deep link: /?domain=example.com renders the result on load. Also support
  // the path form /example.com (read from the pathname) so both URLs behave
  ...
  var initialDomain=getInitialDomain();
  if(initialDomain){
